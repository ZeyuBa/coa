...
from .internal.adapter.imagelab import (
    create_imagelab,
)
from .internal.data import Data
from .internal.display import _Displayer
from .internal.helper_factory import (
    data_issues_factory,
    issue_finder_factory,
    report_factory,
)
from .internal.issue_finder import IssueFinder
from .internal.serialize import _Serializer
...
class Datalab:
    ...
    def report(
        ...
        *,
        ...
        return reporter.report(num_examples=num_examples)
